Contributing to TheUCoin Core
==================================

The TheUCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TheUCoin Core project, and is not to be
confused with overall TheUCoin Network Protocol consensus changes.

Whether a pull request is merged into TheUCoin Core rests with the project merge
...
Patches that change TheUCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the TheUCoin consensus, it must have been
...
The project leader is the release manager for each TheUCoin Core release.
