...
#   c) node1 mines 32 blocks, so now node 0 has 500000TUC, node 1 has 4250TUC, node2 has none.
#   d) node0 sends 601 TUC to node2, in two transactions (301 TUC, then 300 TUC).
