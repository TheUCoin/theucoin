...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        intro.setWindowIcon(QIcon(":icons/tucoin"));
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("TheUCoin Core"),
     ...
     * override -datadir in the theucoin.conf file in the default data directory
     * (to be consistent with theucoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
