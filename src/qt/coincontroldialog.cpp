                                                        ...
                                                        model(0)
{
    ...
    // see https://github.com/tucoin/tucoin/issues/5716
...
void CoinControlDialog::updateLabels(WalletModel* model, QDialog* dialog)
{
    ...
    int nDisplayUnit = BitcoinUnits::TUC;
    ...
    QString toolTip4 = tr("Can vary +/- %1 utuc per input.").arg(dFeeVary);
    ...
    BOOST_FOREACH (PAIRTYPE(QString, vector<COutput>) coins, mapCoins) {
        ...
        for(const COutput& out: coins.second) {
            ...
            if (ExtractDestination(out.tx->vout[out.i].scriptPubKey, outputAddress)) {
                ...
                // if listMode or change => show TUC address. In tree mode, address is not shown again for direct wallet address outputs
