...
static const struct {
    ...
    {"main", QAPP_APP_NAME_DEFAULT, ":/icons/tucoin", "", ":/images/splash"},
    {"test", QAPP_APP_NAME_TESTNET, ":/icons/tucoin_testnet", QT_TRANSLATE_NOOP("SplashScreen", "[testnet]"), ":/images/splash_testnet"},
    {"regtest", QAPP_APP_NAME_TESTNET, ":/icons/tucoin_testnet", "[regtest]", ":/images/splash_testnet"}};
