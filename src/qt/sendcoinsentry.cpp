                                                  ...
                                                  model(0)
{
    ...
    // normal tuc address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying tuc address(es)
    ui->payTo_is->setFont(GUIUtil::tucoinAddressFont());
...
void SendCoinsEntry::clear()
{
    ...
    // update the display unit, to not use the default ("TUC")
    updateDisplayUnit();
}
