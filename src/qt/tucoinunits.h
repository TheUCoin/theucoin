...
#ifndef TUCOIN_QT_TUCOINUNITS_H
#define TUCOIN_QT_TUCOINUNITS_H
...
/** TUC unit definitions. Encapsulates parsing and formatting
...
public:
    ...
    /** TUC units.
      @note Source: https://en.tucoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        TUC,
        mTUC,
