...
#ifndef TUCOIN_KEYSTORE_H
#define TUCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/tucoin/bips/blob/master/bip-0013.mediawiki
