...
{
    BOOST_CHECK(TestSplitHost("www.tucoin.org", "www.tucoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.tucoin.org]", "www.tucoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.tucoin.org:80", "www.tucoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.tucoin.org]:80", "www.tucoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:10222", "127.0.0.1", 10222));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:10222", "127.0.0.1", 10222));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:10222", "::ffff:127.0.0.1", 10222));
    BOOST_CHECK(TestSplitHost("[::]:10222", "::", 10222));
    BOOST_CHECK(TestSplitHost("::10222", "::10222", -1));
    BOOST_CHECK(TestSplitHost(":10222", "", 10222));
    BOOST_CHECK(TestSplitHost("[]:10222", "", 10222));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:10222", "127.0.0.1:10222"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:10222", "[::]:10222"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
