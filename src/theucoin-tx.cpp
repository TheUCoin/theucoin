...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TheUCoin Core theucoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  theucoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded theucoin transaction") + "\n" +
                               "  theucoin-tx [options] -create [commands]   " + _("Create hex-encoded theucoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded theucoin transaction
