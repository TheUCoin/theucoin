...
// Copyright (c) 2017 The TheUCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef TUCOIN_CHAINPARAMS_H
#define TUCOIN_CHAINPARAMS_H
 ...
 * TheUCoin system. There are three: the main network on which people trade goods
