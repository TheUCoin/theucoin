...
#ifndef TUCOIN_COINS_H
#define TUCOIN_COINS_H
...
/**
    ...
    ****Note - for TheUCoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /**
     * Amount of theucoin coming in to a transaction
