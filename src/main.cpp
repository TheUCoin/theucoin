...
#if defined(NDEBUG)
#error "TheUCoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in utuc) are considered zero fee (for relaying and mining)
 * We are ~100 times smaller then tucoin now (2015-06-23), set minRelayTxFee only 10 times higher
...
{
    RenameThread("theucoin-scriptch");
