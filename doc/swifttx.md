...
This mechanism has been integrated into Bitcore-Node-TheUCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/theucoin/insight-api-theucoin#web-socket-api](https://github.com/theucoin/insight-api-theucoin#web-socket-api)
* API: [https://github.com/theucoin/insight-api-theucoin#swifttx-transactions](https://github.com/theucoin/insight-api-theucoin#swifttx-transactions)
...
By default, the TheUCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TheUCoin Core daemon:
