...
Intro
-----
TheUCoin (TUC) is a sustainable cryptocurrency modeled after
...
high-powered mining hardware. TheUCoin utilizes an energy efficient proof-of-stake algorithm,
...
Setup
-----
Unpack the files into a directory and run theucoin-qt.exe.

TheUCoin Core is the original TheUCoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of TheUCoin transactions;
