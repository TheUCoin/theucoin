The following is a list of assets used in the tucoin source and their proper attribution.
...
* License: MIT
* Site: [https://tucointalk.org/index.php?topic=15276.0](https://tucointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original tucoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/tucoin.icns, src/qt/res/src/tucoin.svg,
	src/qt/res/src/tucoin.ico, src/qt/res/src/tucoin.png,
	src/qt/res/src/tucoin_testnet.png, docs/tucoin_logo_doxygen.png,
