...
allowing somebody to distribute a Bitcoin-Qt.app or tucoin-qt-setup.exe with a valid
...
that the tucoin-qt.exe file inside the installer had not been tampered with.
